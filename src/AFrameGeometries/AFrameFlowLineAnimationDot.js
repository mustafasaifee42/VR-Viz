...
AFRAME.registerComponent("animate-points-on-curve", {
  ...
  init: function() {
    ...
    this.curve1 = new THREE.QuadraticBezierCurve3( pointVecs[0],pointset1,pointVecs[1] );
    this.curve2 = new THREE.QuadraticBezierCurve3( pointVecs[1],pointset2,pointVecs[2] );
