    ...
    if (this.props.hover) {
      switch (this.props.type) {
        case 'box':
          {
            return (
              <a-box convert-to-buffer-geometry color={this.props.color} class={'shapes clickable'} opacity={this.props.opacity} depth={this.props.depth} height={this.props.height} width={this.props.width} position={this.props.position} rotation={rotation} change-color-on-hover={`hoverText:${this.props.hoverText}; prevOpacity:${this.props.opacity};focusedObjectOpacity: ${this.props.hover.focusedObject.opacity};focusedObjectfill:${this.props.hover.focusedObject.fill};nonFocusedObjectOpacity:${this.props.hover.nonFocusedObject.opacity};labelWidth:${this.props.hover.label.width};lineHeight:${this.props.hover.label.lineHeight};labelHeight:${this.props.hover.label.height};labelAlign:${this.props.hover.label.align};wrapCount:${this.props.hover.label.wrapCount};labelBackgroundColor:${this.props.hover.label.backgroundColor};labelFontColor:${this.props.hover.label.fontColor};labelPosition:${this.props.hover.label.position};labelRotation:${this.props.hover.label.rotation};prevColor:${this.props.color};graphID:${this.props.graphID};backgroundOpacity:${this.props.hover.label.backgroundOpacity}`} />
            )
          }
        case 'cylinder':
          {
